...
#     bot.rotate_left_deg(90.3)
    ...
    while not maze.inCenter(mouse.getPosition()):
        ...
        moveOneCellFloodFill(maze, mouse, costs, bot)
...
def moveOneCellFloodFill(maze, mouse, costs, bot):
    ...
    turnAndMove(mouse, current, next_cell, bot)
...
def turnAndMove(mouse, current, next_cell, bot):
