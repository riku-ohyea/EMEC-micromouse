...
class DiffDrive:
    def __init__(self, left_motor, right_motor, left_enc, right_enc,
        ...
        self.pid_dist = PID(kp=0.0048, ki=0.0000, kd=0.000045, out_min=-0.3, out_max=0.4, i_limit=0.5)
        # Heading PID drives difference encoder to 0 (straight) or to target (turn).
        self.pid_head = PID(kp=0.00285, ki=0.0000, kd=0.000030, out_min=-0.2, out_max=0.3, i_limit=0.5)
