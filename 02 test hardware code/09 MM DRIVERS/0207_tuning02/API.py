...
def bonk(bot = None, tof = None):
    ...
    bot.move_forward_cm(distance_back, tof=tof, enable_wall_corr=use_wall, wall_corr_cm=7.0)
    bot.move_forward_cm(distance_forward, tof=tof, enable_wall_corr=use_wall, wall_corr_cm=7.0)
